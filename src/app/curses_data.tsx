...
// 階級定義
export const TIER_CONFIG: Record<string, { label: string; color: string; borderColor: string; bgGlow: string }> = {
  apprentice: { label: "見習", color: "#9CA3AF", borderColor: "#9CA3AF", bgGlow: "rgba(156,163,175,0.08)" },
  adept:      { label: "中階", color: "#3B82F6", borderColor: "#3B82F6", bgGlow: "rgba(59,130,246,0.08)" },
  master:     { label: "高階", color: "#8B5CF6", borderColor: "#8B5CF6", bgGlow: "rgba(139,92,246,0.08)" },
  archmage:   { label: "大魔導", color: "#DC2626", borderColor: "#DC2626", bgGlow: "rgba(220,38,38,0.08)" },
  forbidden:  { label: "禁忌", color: "#D4AF37", borderColor: "#1F2937", bgGlow: "rgba(212,175,55,0.06)" },
};
